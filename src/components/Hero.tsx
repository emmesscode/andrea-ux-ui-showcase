...
const Hero = () => {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
      ...
      <div className="absolute top-20 left-10 w-32 h-32 bg-gradient-to-br from-blue-100 to-purple-100 rounded-full opacity-20 animate-[float_6s_ease-in-out_infinite]"></div>
      <div className="absolute bottom-20 right-10 w-24 h-24 bg-gradient-to-br from-pink-100 to-orange-100 rounded-full opacity-20 animate-[float_6s_ease-in-out_infinite_3s]"></div>
      <div className="absolute top-1/2 left-1/4 w-16 h-16 bg-gradient-to-br from-green-100 to-blue-100 rounded-full opacity-10 animate-[float_8s_ease-in-out_infinite_1s]"></div>
    </section>
  );
};
